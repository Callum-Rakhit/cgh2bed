...
sed 's/chr//g' merged_over_46.bed > merged_over_46_nochr.bed

# Use tabix to norrow vcf to regions of interest based on bed
tabix -h -R ./merged_over_46.bed ./wholegenome.vcf.bgz > 46_vcf.vcf